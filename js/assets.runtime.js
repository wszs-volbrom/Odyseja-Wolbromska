(function () {
  ...
  if (!ODYSEJA_CONFIG || !ODYSEJA_UTILS) {
    throw new Error("Assets dependencies failed to load. Make sure config and utils are included before js/assets.runtime.js.");
  }
  ...
  const { makeEdgeTransparentCanvas } = ODYSEJA_UTILS;
...
function loadUiImages() {
  ...
  window.ODYSEJA_ASSETS = Object.freeze({
    COLLECTIBLE_IMAGES,
    ENEMY_IMAGES,
    UI_IMAGES,
    SpriteLoader,
