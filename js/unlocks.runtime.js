(function () {
  ...
  if (!ODYSEJA_SAVE) {
    throw new Error("Unlock system failed to load. Make sure js/save.runtime.js is included before js/unlocks.runtime.js.");
  }
  ...
  async function createUnlockToken(progressData = {}) {
    const payload = {
      v: TOKEN_VERSION,
  ...
  async function verifyUnlockToken(token) {
