...
const ODYSEJA_LEVELS = window.ODYSEJA_LEVELS;
if (!ODYSEJA_LEVELS) {
  throw new Error("Level catalog failed to load. Make sure js/levels.runtime.js is included before game.js.");
}
...
const ODYSEJA_SAVE = window.ODYSEJA_SAVE;
if (!ODYSEJA_SAVE) {
  throw new Error("Save system failed to load. Make sure js/save.runtime.js is included before game.js.");
}

const { SaveSystem } = ODYSEJA_SAVE;

const ODYSEJA_INPUT = window.ODYSEJA_INPUT;
if (!ODYSEJA_INPUT) {
  throw new Error("Input system failed to load. Make sure js/input.runtime.js is included before game.js.");
}

const { InputManager } = ODYSEJA_INPUT;
const ODYSEJA_SYSTEMS = window.ODYSEJA_SYSTEMS;
if (!ODYSEJA_SYSTEMS) {
  throw new Error("Game systems failed to load. Make sure js/systems.runtime.js is included before game.js.");
}
...
if (!ODYSEJA_ASSETS) {
  throw new Error("Game assets failed to load. Make sure js/assets.runtime.js is included before game.js.");
}
...
const ODYSEJA_PLAYER = window.ODYSEJA_PLAYER;
if (!ODYSEJA_PLAYER) {
  throw new Error("Player controller failed to load. Make sure js/player.runtime.js is included before game.js.");
}

const { PlayerController } = ODYSEJA_PLAYER;
const ODYSEJA_COLLECTIBLES = window.ODYSEJA_COLLECTIBLES;
if (!ODYSEJA_COLLECTIBLES) {
  throw new Error("Collectibles system failed to load. Make sure js/collectibles.runtime.js is included before game.js.");
}

const { CollectibleItem } = ODYSEJA_COLLECTIBLES;
const ODYSEJA_ENEMIES = window.ODYSEJA_ENEMIES;
if (!ODYSEJA_ENEMIES) {
  throw new Error("Enemy system failed to load. Make sure js/enemies.runtime.js is included before game.js.");
}
...
const ODYSEJA_AUDIO = window.ODYSEJA_AUDIO;
if (!ODYSEJA_AUDIO) {
  throw new Error("Audio system failed to load. Make sure js/audio.runtime.js is included before game.js.");
}

const { AudioManager } = ODYSEJA_AUDIO;

const ODYSEJA_SHOP = window.ODYSEJA_SHOP;
if (!ODYSEJA_SHOP) {
  throw new Error("Shop system failed to load. Make sure js/shop.runtime.js is included before game.js.");
}

const { SkinShop } = ODYSEJA_SHOP;

const ODYSEJA_PROCEDURAL = window.ODYSEJA_PROCEDURAL;
if (!ODYSEJA_PROCEDURAL) {
  throw new Error("Procedural generator failed to load. Make sure js/procedural.runtime.js is included before game.js.");
}

const { ProceduralLevelGenerator } = ODYSEJA_PROCEDURAL;
const ODYSEJA_BUS = window.ODYSEJA_BUS;
if (!ODYSEJA_BUS) {
  throw new Error("Bus ride system failed to load. Make sure js/bus.runtime.js is included before game.js.");
}

const { BusRideLevelSystem } = ODYSEJA_BUS;
const ODYSEJA_TRAIN = window.ODYSEJA_TRAIN;
if (!ODYSEJA_TRAIN) {
  throw new Error("Train ride system failed to load. Make sure js/train.runtime.js is included before game.js.");
}

const { TrainRideLevelSystem } = ODYSEJA_TRAIN;
const ODYSEJA_RENDERING = window.ODYSEJA_RENDERING;
if (!ODYSEJA_RENDERING) {
  throw new Error("Rendering helpers failed to load. Make sure js/rendering.runtime.js is included before game.js.");
}
...
window.ODYSEJA_GAME = Object.freeze({
  GameManager,
});
