...
if (!ODYSEJA_UTILS) {
  throw new Error("Train ride system failed to load. Make sure js/utils.runtime.js is included before js/train.runtime.js.");
}
const { clamp, canvasFont, formatTime } = ODYSEJA_UTILS;
...
window.ODYSEJA_TRAIN = Object.freeze({
  TRAIN_ROUTE_SEGMENTS,
  TRAIN_STATIONS,
  RailSignal,
  TrainRouteMap,
  TrainController,
  TrainRideLevelSystem,
});
})();
