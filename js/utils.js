import { GAME_FONT } from "./config.js";



export const canvasFont = (weight, size) => `${weight} ${size}px ${GAME_FONT}`;



export function drawNameTag(ctx, text, x, y, size = 18) {
  ctx.save();
...
export function makeEdgeTransparentCanvas(img) {
