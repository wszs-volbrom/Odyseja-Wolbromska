import { CONFIG, THEME_PALETTES } from "./config.js";
import { clamp, canvasFont } from "./utils.js";
export function renderGameFrame(game) {
    const ctx = game.ctx;
...
export function renderDim(game, ctx) {
...
export function renderBackground(game, ctx) {
...
export function renderParallaxRoad(game, ctx, theme) {
    const w = game.canvas.width;
    const h = game.canvas.height;
...
export function renderBackdropLayer(game, ctx) {
...
export function drawAssetInBox(ctx, img, x, y, w, h) {
...
export function renderWorld(game, ctx) {
...
export function renderDetails(game, ctx) {
...
export function renderPlatform(game, ctx, p) {
...
export function renderCheckpoints(game, ctx) {
...
export function renderFinish(game, ctx) {
...
export function renderFloatingTexts(game, ctx) {
    ctx.save();
    ctx.textAlign = "center";
